...
export default function SignUp() {
    ...
    const userRegistrationUrl = "http://localhost:5001/api/v1/user/customer";
        ...
        <form ref={formRef} onSubmit={handleSubmit}>
            ...
            <div>
                <button
                    ...
                    className={`flex justify-center w-full my-5 px-4 py-2 text-sm font-medium text-white border border-transparent rounded ${buttonDisabled ? "bg-orange-300" : " bg-orange-500 hover:bg-orange-700"} transform duration-300 ease-in-out focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-blue-500`}
                >
                {!loading && <p>Sign in</p>}
                {loading && 
            ...
            <p className='text-slate-800 text-sm'>Already have an account? <span className='text-sm font-semibold text-orange-500'><Link to={"/guest/login"}>Sign in</Link></span></p>
        </form>
    </section>
  )
}
